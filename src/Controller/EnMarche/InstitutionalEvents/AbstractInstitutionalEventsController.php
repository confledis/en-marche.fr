...
abstract class AbstractInstitutionalEventsController extends Controller
{
    ...
    public function institutionalEventsAction(
        ...
        return $this->renderTemplate('institutional_events/list.html.twig', [
            'institutional_events' => $institutionalEventRepository->findByOrganizer($this->getMainUser($request)),
        ]);
    }
    ...
    public function institutionalEventsCreateAction(
        ...
        $command = new InstitutionalEventCommand($this->getMainUser($request));
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToInstitutionalEventsRoute($request, 'list');
        }
